...
class I18nTranslator:
    def __init__(self, processor: I18nProcessor):
        ...
        self.locales_path = StdPath(processor.locales_path).resolve()
    ...
    def translate_map(
        ...
        return {
            self.T(f'{prefix}.{k}', locale): (
                v if v is not None else self.T('text.unknown', locale)
            )
