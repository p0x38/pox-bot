...
class TTSManager:
        ...
        self.pocket_tts_custom_models = [
            {
                ...
                'path': '/src/poxbot/assets/voices/pocket-tts/sam.safetensors',
            },
            {
                'name': 'zira',
                'friendly_name': 'Microsoft Zira',
                'path': '/src/poxbot/assets/voices/pocket-tts/zira.safetensors',
            },
            {
                'name': 'sam-v2',
                'friendly_name': 'Microsoft Sam V2',
                'path': '/src/poxbot/assets/voices/pocket-tts/sam-v2.safetensors',
            },
            {
                'name': 'zira-v2',
                'friendly_name': 'Microsoft Zira V2',
                'path': '/src/poxbot/assets/voices/pocket-tts/zira-v2.safetensors',
            },
            {
                'name': 'carl',
                'friendly_name': 'High pitched TruVoice Adult Male 1',
                'path': '/src/poxbot/assets/voices/pocket-tts/carl.safetensors',
            },
            {
                'name': 'mary',
                'friendly_name': 'Microsoft Mary',
                'path': '/src/poxbot/assets/voices/pocket-tts/mary.safetensors',
            },
            {
                'name': 'mike',
                'friendly_name': 'Microsoft Mike',
                'path': '/src/poxbot/assets/voices/pocket-tts/mike.safetensors',
            },
            {
                'name': 'truvoice-af1',
                'friendly_name': 'TruVoice Adult Female 1',
                'path': '/src/poxbot/assets/voices/pocket-tts/truvoice-af1.safetensors',
            },
            {
                'name': 'truvoice-am1',
                'friendly_name': 'TruVoice Adult Male 1',
                'path': '/src/poxbot/assets/voices/pocket-tts/truvoice-am1.safetensors',
            },
            {
                'name': 'missile',
                'friendly_name': 'Missile knows where it is',
                'path': '/src/poxbot/assets/voices/pocket-tts/missile.safetensors',
            },
            {
                'name': 'sweep',
                'friendly_name': 'Sine Sweep',
                'path': '/src/poxbot/assets/voices/pocket-tts/sweep.safetensors',
            },
            {
                'name': 'triangle-sweep',
                'friendly_name': 'Triangle Sweep',
                'path': '/src/poxbot/assets/voices/pocket-tts/triangle-sweep.safetensors',
            },
            {
                'name': 'me',
                'friendly_name': 'Me',
                'path': '/src/poxbot/assets/voices/pocket-tts/me.safetensors',
            },
            {
                'name': 'triangle',
                'friendly_name': 'Triangle Wave',
                'path': '/src/poxbot/assets/voices/pocket-tts/triangle.safetensors',
            },
            {
                'name': 'sine',
                'friendly_name': 'Sine Wave',
                'path': '/src/poxbot/assets/voices/pocket-tts/sine.safetensors',
            },
            {
                'name': 'dtmf',
                'friendly_name': 'DTMF Tone',
                'path': '/src/poxbot/assets/voices/pocket-tts/dtmf.safetensors',
            },
            {
                'name': 'vc1',
                'friendly_name': 'Voice 1',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc1.safetensors',
            },
            {
                'name': 'vc2',
                'friendly_name': 'Voice 2',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc2.safetensors',
            },
            {
                'name': 'vc3',
                'friendly_name': 'Voice 3',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc3.safetensors',
            },
            {
                'name': 'vc4',
                'friendly_name': 'Voice 4',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc4.safetensors',
            },
            {
                'name': 'vc5',
                'friendly_name': 'Voice 5',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc5.safetensors',
            },
            {
                'name': 'vc5-lq',
                'friendly_name': 'Voice 5 Low Quality',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc5-lq.safetensors',
            },
            {
                'name': 'vc6',
                'friendly_name': 'Voice 6',
                'path': '/src/poxbot/assets/voices/pocket-tts/vc6.safetensors',
            },
            {
                'name': 'gtts',
                'friendly_name': 'gTTS',
                'path': '/src/poxbot/assets/voices/pocket-tts/gtts.safetensors',
            },
        ]
    ...
    async def cog_load(self):
        ...
        self.piper_voice = PiperVoice.load('./src/poxbot/assets/voices/en_US-ryan-high.onnx')
    ...
    async def generate_speech(self, data: dict[str, Any]):
        ...
        match data['engine']:
            ...
            case TTSEngineType.POCKET_TTS:
                ...
                if not speech_voice:
                    speech_voice = (
                        self.bot.root_path + self.pocket_tts_custom_models[0]['path']
                    )
                ...
                generated = self.pocket_tts_model.generate_audio(
                    voice_state, input_text,
                )
