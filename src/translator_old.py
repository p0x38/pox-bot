...
class I18nTranslator:
    def __init__(self, locales_path: str = "src/assets/locales"):
        ...
        def missing_handler(key, locale, **kwargs):  # noqa: ARG001
            return self.MISSING
        ...
        if is_missing or is_same_as_en:
            ...
            if self.batch_task is None:
                try:
                    ...
                    self.batch_task.add_done_callback(lambda _t: setattr(self, "batch_task", None))
                except RuntimeError:
                    pass
    ...
    @overload
    def T(self, text: str,
          locale: str | Locale, placeholders: dict[str, Any] | None = None, **kwargs) -> str: ...

    def T(self, text: str,
          locale: str | Locale | None = None, placeholders: dict[str, Any] | None = None,
          **kwargs) -> str | app_commands.locale_str:
        if locale is None:
            return text
...
class DiscordI18nTranslator(app_commands.Translator):
    ...
    async def translate(self, string: app_commands.locale_str,
                        locale: Locale, context: app_commands.TranslationContext) -> str | None:
        key = str(string)
...
translator_instance = I18nTranslator(locales_path="src/assets/locales")
