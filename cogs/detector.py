...
class DetectionCog(commands.Cog):
    ...
    detector_group = app_commands.Group(name="detect", description=app_commands.locale_str("command.detect.description"), allowed_contexts=app_commands.AppCommandContext(guild=True, dm_channel=True, private_channel=True))
    
    @cached(300)
    @detector_group.command(name="how_gay", description=app_commands.locale_str("command.detect.how_gay.description"))
    ...
    @cached(300)
    @detector_group.command(name="how_slop", description=app_commands.locale_str("command.detect.how_slop.description"))
    @app_commands.describe(member="Member to check")
    ...
    @cached(300)
    @detector_group.command(name="how_femboy", description=app_commands.locale_str("command.detect.how_femboy.description"))
    @app_commands.describe(member="Member to check")
    ...
    @cached(300)
    @detector_group.command(name="how_freaky", description=app_commands.locale_str("command.detect.how_freaky.description"))
    @app_commands.describe(member="Member to check")
    ...
    @cached(300)
    @detector_group.command(name="how_silly", description=app_commands.locale_str("command.detect.how_freaky.description"))
    @app_commands.describe(member="Member to check")
    ...
    @cached(300)
    @detector_group.command(name="custom_member", description=app_commands.locale_str("command.detect.custom_member.description"))
    @app_commands.describe(member="Member to check")
    async def custom_detection(self, interaction: Interaction, member: Member | User, *, custom: str):
        await interaction.response.defer(thinking=True)
        #randum = int(random.random()*100)
        #dac = check_map(randum,100)
        dac = check_map()
    ...
    @cached(300)
    @detector_group.command(name="custom2", description=app_commands.locale_str("command.detect.custom2.description"))
