...
class ChannelCog(commands.Cog):
    ...
    group = app_commands.Group(name="channel", description=app_commands.locale_str("command.channel.description"))
    
    @group.command(name="slowmode", description=app_commands.locale_str("command.channel.slowmode.description"))
