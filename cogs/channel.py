...
class ChannelCog(commands.Cog):
    ...
    async def set_slowmode_delay(
        ...
        embed = Embed(
            description=translator_instance.T("text.unknown", loc), color=Color.red()
        )
        ...
        try:
            ...
            success_embed = Embed(
                title=translator_instance.T(
                    "command.channel.slowmode.embeds.successful.title", loc
                ),
                description=translator_instance.T(
    ...
    async def get_channel_info(self, interaction: Interaction, channel: GuildChannel):
        ...
        if channel:
            ...
            if isinstance(channel, TextChannel):
                extrarows = {
                    "channel_slowmode": stuff.format_seconds(channel.slowmode_delay)
                ...
                extrarows = {
                    "channel_nsfw": stuff.format_boolean(channel.nsfw),
                    "channel_instance_running": stuff.format_boolean(
