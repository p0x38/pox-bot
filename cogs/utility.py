...
class UtilityCog(commands.Cog):
    ...
    @app_commands.command(name=app_commands.locale_str("8ball", message="command.8ball.name"), description=app_commands.locale_str("Gives a random, classic magic 8-ball response to a user's question.", message="command.8ball.description"))
