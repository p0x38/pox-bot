...
class ExporterCog(commands.Cog):
    ...
    def _generate_commands_json(self) -> list:
        ...
        def parse_slash_command(cmd: app_commands.Command | app_commands.Group | app_commands.ContextMenu, parent_name: str = "") -> dict[str, Any]:
        ...
        def parse_prefix_command(cmd: commands.Command | commands.Group, parent_name: str = "") -> dict[str, Any]:
            full_name = f"{parent_name} {cmd.name}".strip()
